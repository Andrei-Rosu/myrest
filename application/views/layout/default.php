...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>assets/vendor/js/pagination.js"></script>
		<link rel="stylesheet" href="<?php echo base_url('assets/local/css/stylesheet.css'); ?>"></link>
		<link rel="stylesheet" href="<?php echo base_url('assets/local/css/popup.css'); ?>"></link>
