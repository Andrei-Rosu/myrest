...
<p><label>Contenu :</label><textarea id="blogpost_add_content" name="content_bb"><?php echo isset($blogpost_add_pop['content_bb']) ? $blogpost_add_pop['content_bb'] : '' ?></textarea></p>
