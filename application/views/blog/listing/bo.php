	...
	<div class="row padding-bottom">
		...
		<div class="col-md-8">
			<div class="post-summary">      
				...
				<p>
					<a href="<?php echo base_url('bo/tutorials/see/'.$blogpost->id); ?>" class="btn btn-default btn-sm">Lire</a>
					<a href="<?php echo base_url('bo/tutorials/edit/'.$blogpost->id); ?>" class="btn btn-default btn-sm">Modifier</a>
					<a href="#" class="confirm btn btn-danger btn-sm" 
					   data-url="<?php echo base_url('bo/tutorials/delete/'.$blogpost->id) ?>" 
