...
class BBCodeParser extends JBBCode\Parser {
	...
	public function __construct() {
		...
		$builder = new JBBCode\CodeDefinitionBuilder('section2', '<h3 class="section" >{param}</h3>');
		$this->addCodeDefinition($builder->build());

		$builder = new JBBCode\CodeDefinitionBuilder('section3', '<h4 class="section" >{param}</h4>');
		$this->addCodeDefinition($builder->build());
		$builder = new JBBCode\CodeDefinitionBuilder('h1', '<h2>{param}</h1>');
		//$builder->setUseOption(true);
		$this->addCodeDefinition($builder->build());

		$builder = new JBBCode\CodeDefinitionBuilder('h2', '<h3>{param}</h2>');
		$this->addCodeDefinition($builder->build());
